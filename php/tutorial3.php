...
<body>
  <div class="content">
    ...
    <div id="listing">
      ...
      <div class="title">
        Amenajarea gradinii in stil rustic
        <button class="btn" id="1" onclick="myFunction(this)">Citit</button>
      </div>
      <div class="continut">

        Gradinile rustice sunt pline de verdeata si de culoare, iar elementul central este reprezentat de lemn. Poti
        ...
        special cele lucrate manual, sunt ideale daca vrei sa creezi o gradina in stil rustic.

      </div>

      <div class="title">
        Amenajarea gradinii in stil frantuzesc
        <button class="btn" id="2" onclick="myFunction(this)">Citit</button>
      </div>

      <div class="continut">
        Simetria si ordinea sunt doua dintre trasaturile principale ale unei gradini in stil frantuzesc. Cararile din
        ...
        amenajezi in iaz artificial sau o fantana arteziana, pentru un plus de rafinament al gradinii.
      </div>

      <div class="title">
        Amenajarea gradinii in stil englezesc
      ...
      <div class="continut">
        ...
        ceramica, iazurile ornamentale, casutele pentru pasari sau statuile.
      </div>

      <div class="title">
        Amenajarea gradinii in stil japonez
        <button class="btn" id="4" onclick="myFunction(this)">Citit</button>
      </div>

      <div class="continut">
        Principiul estetic pe care se bazeaza organizarea gradinilor japoneze este cunoscut sub denumirea de „fukinsei”,
        ...
        gradinii tale. Gasesti aici cateva idei despre influenta stilului japonez in amenajarile interioare.
      </div>

      <div class="title">
        Amenajarea gradinii in stil vintage
        <button class="btn" id="5" onclick="myFunction(this)">Citit</button>
      </div>

      <div class="continut">
        Gradinile in stil vintage au acel aspect care ne duc cu gandul la curtile vechi, in care plantele s-au extins in
        ...
        folosi sunt alama, fierul, lemnul, metalul sau caramida.
      </div>

      <div class="title">
        Amenajarea gradinii in stil modern
        <button class="btn" id="6" onclick="myFunction(this)">Citit</button>
      </div>

      <div class="continut">
        Gradinile amenajate in stil modern sunt definite de elemente grafice cu design minimalist si de linii clare.
        ...
        potrivit atat pentru gradini mici, cat si pentru gradini mari.
      </div>

    </div>

  </div>
  <form action="../quiz3.html"><button class="buton">Start quiz</button></form>
