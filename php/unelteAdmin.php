...
if (!isset($_SESSION['userId']))
{
  ...
  {   
    ...
    echo "<br>";
    echo "<p>$descriere</p>";
    echo "<form action = 'unelteAdmin.php' method='post'> <button onClick='window.location.reload()' name='delete' value='$id' ><img src='https://image.flaticon.com/icons/png/512/61/61848.png' height='35' width='30'></button>";
    echo "</div> </div>";
    echo "</div>";
  }
