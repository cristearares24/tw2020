...
<body>
  <div class="content">
    ...
    <div id="listing">
      ...
      <div class="title">
        Amenajarea unei curti de dimensiuni foarte mici
        <button class="btn" id="1" onclick="myFunction(this)">Citit</button>
      </div>
      <div class="continut">

        Curtile de dimensiuni foarte mici necesita o atentie aparte prin nevoia de a valorifica spatiul, gradina se va
        ridica pe verticala, iar gardul poate fi imbracat in iedera sau plante cataratoare. Mobilierul de gradina va fi
        pozitionat cat mai aproape de casa in forma de insula.
      </div>

      <div class="title">
        Amenajarea unei curti sau gradini pentru un efort minim
        <button class="btn" id="2" onclick="myFunction(this)">Citit</button>
      </div>

      <div class="continut">
        Pentru aceia dintre voi care nu au timp, este important sa investeasca minim efort in ingrijirea unei curti sau
        ...
        fiindca va micsoreaza efortul cand tundeti iarba.
      </div>

      <div class="title">
        Amenajarea unei gradini sau curte in panta
        <button class="btn" id="3" onclick="myFunction(this)">Citit</button>
      </div>

      <div class="continut">
        Amenajarea unei gradini sau a unei curti in panta atrage eforturi financiare suplimentare pentru aranjarea
      ...
      <div class="title">
        Amenajarea unei gradini sau curti la munte
        <button class="btn" id="4" onclick="myFunction(this)">Citit</button>
      </div>

      <div class="continut">
        Gradinile si curtile de munte impun o mai mare rigoare in alegerea plantelor pentru a rezista climei si solului
        ...
        specia coniferelor, iar plante salbatice sau aromatice simple pot inlocui ansamble ornamentale complexe.
      </div>

      <div class="title">
        Amenajarea unei gradini sau curti la mare
        <button class="btn" id="5" onclick="myFunction(this)">Citit</button>
      </div>

      <div class="continut">
        Desi pare o provocare amenajarea unor gradini sau curti la mare, problema solului nisipos poate fi rezolvata
  ...
  <form action="../quiz4.html"><button class="buton">Start quiz</button></form>
