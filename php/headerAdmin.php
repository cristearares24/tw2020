    ...
    <div class="header">
        <div class="inner_header">
            ...
            <nav>
                ...
                <ul>
                    <li><a href="./indexAdmin.php">Acaasă</a></li>
                    <li><a href="./tutorialeAdmin.php">Tutoriale</a></li>
                    <form action="./myProfileAdmin.php" style="display:inline" method="POST">
                        <input type="hidden" name="profileresults" id="inp" value=" " />
                        <li> <a href="javascript:;" onclick="ajaxRequest(this); ">Profilul meu</a></li>
                    </form>
                        <li><a href="./unelteAdmin.php">Unelte</a></li>               
                        <?php
